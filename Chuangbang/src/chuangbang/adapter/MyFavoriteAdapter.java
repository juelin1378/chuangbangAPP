...
public class MyFavoriteAdapter extends BaseAdapter{
	...
	public MyFavoriteAdapter(List<Project> data,Context context){
		if (data == null) {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if(convertView==null){
			...
			convertView=inflater.inflate(R.layout.item_my_favorite_project,null);
			holder.tvName=(TextView)convertView.findViewById(R.id.tv_favorite_name);
			holder.tvDomain=(TextView)convertView.findViewById(R.id.tv_favorite_domain);
			holder.tvDescription=(TextView)convertView.findViewById(R.id.tv_favorite_description);
			holder.tvDate=(TextView)convertView.findViewById(R.id.tv_favorite_date);
			holder.tvComment=(TextView)convertView.findViewById(R.id.tv_favorite_comments);
			holder.roundImage=(ImageView)convertView.findViewById(R.id.iv_favorite_avatar);
			holder.tvFavorite=(TextView)convertView.findViewById(R.id.tv_favorite_favorite);
